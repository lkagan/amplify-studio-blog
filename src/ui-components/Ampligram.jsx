  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imagetlx")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icontzh")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vectorwdy")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagerii")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIconpyo")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="chat-bubble-outline"
            {...getOverrideProps(overrides, "MyIcontls")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="send"
            {...getOverrideProps(overrides, "MyIconmqr")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconnbw")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vectoroti")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
