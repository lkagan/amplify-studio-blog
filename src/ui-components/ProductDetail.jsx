      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7pev")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerqxd")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7zjq")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerost")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7uav")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28uqd")}
          >
            <Button
              borderRadius="4px"
              display="flex"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonmdc")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttoncbq")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonogn")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonscr")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28jvr")}
          >
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonzvx")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonppn")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonjbw")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttonupo")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
