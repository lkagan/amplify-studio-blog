  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              shrink="0"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconqim")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Sharehct")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Shareybs")}
            ></Text>
            <MyIcon
              shrink="0"
              type="bookmark_border"
              {...getOverrideProps(overrides, "MyIconwzf")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="share"
              {...getOverrideProps(overrides, "MyIconfuo")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIconllb")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read morehvb")}
      >
        <MyIcon
          shrink="0"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIconeds")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read morezar")}
        ></Text>
      </Flex>
    </Flex>
  );
