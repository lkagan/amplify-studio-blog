      ...
      >
        ...
        >
          <Badge
            ...
            variation="default"
            children="New"
            {...getOverrideProps(overrides, "Badgejle")}
          ></Badge>
          <Badge
            fontSize="12px"
            lineHeight="12px"
            ...
            variation="default"
            children="Classic"
            {...getOverrideProps(overrides, "Badgelzbaop")}
          ></Badge>
          <Badge
            fontSize="12px"
            lineHeight="12px"
            ...
            variation="default"
            children="Modern"
            {...getOverrideProps(overrides, "Badgelzbhwm")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featuregci")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconupu")}
            >
              <Icon
                width="17.58984375px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorsxf")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurehks")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconenl")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorfjq")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurehab")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconlyu")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorhzf")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
