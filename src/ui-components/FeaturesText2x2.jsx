        ...
        >
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136aey")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconzfa")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectoroqf")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.nwg"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376ayb")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconydb")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorazu")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.oih"
                )}
              ></Text>
            </Flex>
          </Flex>
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136qsp")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconvnp")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorwmg")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.xov"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376yeh")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconfte")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorzmn")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.enn"
                )}
              ></Text>
            </Flex>
          </Flex>
